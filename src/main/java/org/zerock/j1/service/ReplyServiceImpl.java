...
public class ReplyServiceImpl implements ReplyService {
  ...
  public PageResponseDTO<ReplyDTO> list(ReplyPageRequestDTO requestDTO) {
    ...
    Pageable pagealbe = PageRequest.of(pageNum - 1, requestDTO.getSize(), Sort.by("rno").ascending());

    Page<Reply> result = replyRepository.listBoard(requestDTO.getBno(), pagealbe);
